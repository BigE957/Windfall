...
namespace Windfall.Content.UI.Events
{
    ...
    {
        public override bool IsActive => LunarCultActivitySystem.IsRitualActivityActive();
        public override float CompletionRatio => Clamp((float)LunarCultActivitySystem.PortalsDowned / (float)LunarCultActivitySystem.RequiredPortalKills, 0f, 1f);
