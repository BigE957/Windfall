...
namespace Windfall.Content.UI
{
    ...
    internal class ChefProgressBar : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            barBackground.BorderColor = Color.RosyBrown;
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            NPC chef = Main.npc.First(n => n.active && n.type == ModContent.NPCType<TheChef>());
            // Calculate quotient
            float quotient = chef.ai[2] / 360; // Creating a quotient that represents the difference of your currentResource vs your maximumResource, resulting in a float of 0-1f.
