...
public class LemonButterHermititanLegs : ModItem
{
    public override string Texture => $"Windfall/Assets/Items/Food/{nameof(LemonButterHermititanLegs)}";
    ...
    {
        player.AddBuff(BuffID.Titan, 57600);
    }
