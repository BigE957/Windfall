...
public class EutrophicClamChowder : ModItem
{
    public override string Texture => $"Windfall/Assets/Items/Food/{nameof(EutrophicClamChowder)}";
    ...
    {
        player.AddBuff(BuffID.Flipper, 57600);
    }
