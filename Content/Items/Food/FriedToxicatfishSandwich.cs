...
{
    public class FriedToxicatfishSandwich : ModItem
    {
        public override string Texture => $"Windfall/Assets/Items/Food/{nameof(FriedToxicatfishSandwich)}";
        ...
        {
            player.AddBuff(ModContent.BuffType<SulphurskinBuff>(), 57600);
        }
