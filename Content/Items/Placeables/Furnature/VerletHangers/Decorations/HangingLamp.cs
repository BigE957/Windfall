...
public class HangingLamp : Decoration, ILocalizedModType
{
    ...
    public override int DecorID => DecorationID.HangingLamp;
    ...
    {
        Texture2D texture = ModContent.Request<Texture2D>("Windfall/Content/Items/Placeables/Furnature/VerletHangers/Decorations/HangingLamp").Value; ;
