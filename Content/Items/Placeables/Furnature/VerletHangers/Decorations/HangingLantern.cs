...
public class HangingLantern : Decoration, ILocalizedModType
{
    ...
    public override int DecorID => DecorationID.HangingLantern;
    ...
    {
        Texture2D texture = ModContent.Request<Texture2D>("Windfall/Content/Items/Placeables/Furnature/VerletHangers/Decorations/HangingLantern").Value; ;
