...
public class ChaseMusicScene : ModSceneEffect
{
    ...
    public override bool IsSceneEffectActive(Player player) => DraconicRuinsSystem.State == DraconicRuinsSystem.CutsceneState.Fumble && DraconicRuinsSystem.DraconicRuinsArea.Contains(player.Center.ToTileCoordinates());
