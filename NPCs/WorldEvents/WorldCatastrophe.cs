...
public class WorldCatastrophe : ModNPC
{
    ...
    public override void SetDefaults()
    {
        ...
        NPC.damage = Main.masterMode ? 216 : (CalamityWorld.death ? 162 : (CalamityWorld.revenge ? 150 : (Main.expertMode ? 130 : 65)));
        NPC.npcSlots = 5f;
        NPC.width = 120;
        NPC.height = 120;
    ...
    {
        CalamityAIs.CatastropheAI(NPC, Mod);
    }
    ...
    public override void HitEffect(NPC.HitInfo hit)
    {
        ...
        if (NPC.life <= 0)
        {
            if (Main.netMode != NetmodeID.Server)
            {
                ...
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, calamity.Find<ModGore>("Catastrophe").Type, NPC.scale);
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, calamity.Find<ModGore>("Catastrophe2").Type, NPC.scale);
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, calamity.Find<ModGore>("Catastrophe3").Type, NPC.scale);
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, calamity.Find<ModGore>("Catastrophe4").Type, NPC.scale);
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, calamity.Find<ModGore>("Catastrophe5").Type, NPC.scale);
            }
            NPC.width = 100;
            NPC.height = 100;
